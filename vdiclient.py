...
def loadconfig(config_location = None, config_type='file', config_username = None, config_password = None, ssl_verify = True, config_location_backup = 'https://cc.percfab.com/ini/vdiclient.ini'):
	...
	if config_type == 'file':
		if config_location:
			...
			if os.name == 'nt': # Windows
				config_list = [
					f'{os.getenv("APPDATA")}\\PercFabVDIClient\\vdiclient.ini',
					f'{os.getenv("PROGRAMFILES")}\\PercFabVDIClient\\vdiclient.ini',
					f'{os.getenv("PROGRAMFILES(x86)")}\\PercFabVDIClient\\vdiclient.ini',
					'C:\\Program Files\\PercFabVDIClient\\vdiclient.ini'
				]
				
			elif os.name == 'posix': #Linux
				config_list = [
					os.path.expanduser('~/.config/PercFabVDIClient/vdiclient.ini'),
